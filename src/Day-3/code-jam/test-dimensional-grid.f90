program main
  ...
  !!
  !! Establish a coarray for distributing dimensional-grid vertex locations across images.
  !! Use collective subroutines to distribute the grid dimensions and verify load distribution
   ...
   use dimensional_grid_interface, only : dimensional_grid, space_dimension

   implicit none

   integer, allocatable :: nx(:)
   type(dimensional_grid) :: mesh[*]
